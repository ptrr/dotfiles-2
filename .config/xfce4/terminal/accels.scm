...
;
(gtk_accel_path "<Actions>/terminal-window/goto-tab-4" "<Primary><Alt>4")
(gtk_accel_path "<Actions>/terminal-window/goto-tab-3" "<Primary><Alt>3")
...
(gtk_accel_path "<Actions>/terminal-window/goto-tab-1" "<Primary><Alt>1")
...
(gtk_accel_path "<Actions>/terminal-window/goto-tab-8" "<Primary><Alt>8")
(gtk_accel_path "<Actions>/terminal-window/goto-tab-2" "<Primary><Alt>2")
...
(gtk_accel_path "<Actions>/terminal-window/goto-tab-5" "<Primary><Alt>5")
